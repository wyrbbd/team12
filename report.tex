...
\hypersetup{
            pdftitle={Analysis of Australian victims from 2010 to 2019},
            pdfborder={0 0 0},
            breaklinks=true}
...
For my part, my main job is to investigate the victims for the different age groups. I divide the age into four group, teenage, adult, elder adult, and elder. I will compare different class of victims for different groups

\begin{figure}
\centering
\includegraphics{report_files/figure-latex/ageplot-1.pdf}
\caption{\label{fig:ageplot}Age groups between 2010 to 2019}
\end{figure}

From \ref{fig:ageplot}, we can see that the trend for both teenage and adult is very similar. it has a decrease trend from 2010 to 2015. Then, it has a increase trend from 2015 to 2019. For the elder adult and elder, they have increase trend for all year.
...
From \ref{fig:agedist}. the largest group of victim is 20-34 years old, the small group of victim is 55 years and over. Then, the most of victim of sexual and abduction are very young, which is 0-19 year old.

For all class of victims

\begin{figure}
\centering
\includegraphics{report_files/figure-latex/classplot-1.pdf}
\caption{\label{fig:classplot}all class}
\end{figure}

The \ref{fig:classplot} shows that the the number of people committed Sexual is the largest, the total number is more than 20000. the number of people who are 0-19 is the largest. the second largest class of victims is robbery, the total number is about 100000 people.

Then, There are the each class victims for the different groups
