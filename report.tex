...
\begin{center}\includegraphics[width=0.5\linewidth]{report_files/figure-latex/unnamed-chunk-3-1} \end{center}

\begin{itemize}
\tightlist
\item
  On the whole, it shows an upward trend year by year.\\
\item
  The number of female victims is much higher than that of male victims, almost twice.
\end{itemize}

\begin{center}\includegraphics[width=0.5\linewidth]{report_files/figure-latex/unnamed-chunk-4-1} \end{center}
...
\item
  ...
  \item
    Many women may choose not to report the crime for reasons such as public opinion or fear of retribution
  \end{itemize}
\end{itemize}
